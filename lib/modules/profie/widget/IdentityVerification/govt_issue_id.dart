...
class GovtIssueId extends StatefulWidget {
  const GovtIssueId({Key? key}) : super(key: key);

  @override
  _GovtIssueIdState createState() => _GovtIssueIdState();
}

class _GovtIssueIdState extends State<GovtIssueId> {
  bool pinCode = false;
  @override
          ...
          Expanded(
            child: ListView.separated(
                itemBuilder: (context, index) {
                  GovtItem item = GovtItem.loadGovtItem1(context)[index];
                ...
                itemCount: GovtItem.loadGovtItem1(context).length),
          )
        ],
      ),
    );
